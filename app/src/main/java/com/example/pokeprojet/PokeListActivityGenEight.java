...
public class PokeListActivityGenEight extends AppCompatActivity {


    ListView list;

    private String[] pokeName = new String[96];

    private String[] pokeID = new String[96];

    private String[] spriteUrls = new String[96];
    ...
    public void call() {
        ...
        executor.execute(new Runnable() {
            ...
            public void run() {
                ...
                String name_id = getDataFromHTTP("https://pokeapi.co/api/v2/pokemon?limit=96&offset=811");
...
//                                System.out.println("index + " + j);
                                ...
                                pokeID[j] = Integer.toString(j + +152+100+135+107+156+72+88);
                                int test = j+152;
                                System.out.println("numero : " + j+test);

                                String param = Integer.toString(j+152+100+135+107+156+72+88);
