...
public class PokeListActivityGenSix extends AppCompatActivity {


    ListView list;

    private String[] pokeName = new String[72];

    private String[] pokeID = new String[72];

    private String[] spriteUrls = new String[72];
    ...
    public void call() {
        ...
        executor.execute(new Runnable() {
            ...
            public void run() {
                ...
                String name_id = getDataFromHTTP("https://pokeapi.co/api/v2/pokemon?limit=72&offset=649");
...
//                                System.out.println("index + " + j);
                                ...
                                pokeID[j] = Integer.toString(j + +152+100+135+107+156);
                                int test = j+152;
                                System.out.println("numero : " + j+test);

                                String param = Integer.toString(j+152+100+135+107+156);
