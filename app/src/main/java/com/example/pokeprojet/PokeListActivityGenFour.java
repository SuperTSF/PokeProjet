...
public class PokeListActivityGenFour extends AppCompatActivity {


    ListView list;

    private String[] pokeName = new String[107];

    private String[] pokeID = new String[107];

    private String[] spriteUrls = new String[107];
    ...
    public void call() {
        ...
        executor.execute(new Runnable() {
            ...
            public void run() {
                ...
                String name_id = getDataFromHTTP("https://pokeapi.co/api/v2/pokemon?limit=107&offset=386");
...
//                                System.out.println("index + " + j);
                                ...
                                pokeID[j] = Integer.toString(j + +152+100+135);
                                int test = j+152;
                                System.out.println("numero : " + j+test);

                                String param = Integer.toString(j+152+100+135);
