...
public class PokeListActivityGenOne extends AppCompatActivity {
    ...
    private String[] pokeName = new String[151];

    private String[] pokeID = new String[151];

    private String[] spriteUrls = new String[151];
    ...
    public void call() {
        ...
        executor.execute(new Runnable() {
            ...
            public void run() {
                ...
                String name_id = getDataFromHTTP("https://pokeapi.co/api/v2/pokemon?limit=151&offset=0");
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            for (int j = 0; j < results.length(); j++) {
                                ...
                                pokeName[j] = name;
                                pokeID[j] = Integer.toString(j + 1);

                                String param = Integer.toString(j+1);
                                getSprites(param, j);
    ...
    public void getSprites(String param, int index) {
        ...
        executor.execute(new Runnable() {
            ...
            public void run() {
                ...
                String sprites = getDataFromHTTP(spriteUrl);
