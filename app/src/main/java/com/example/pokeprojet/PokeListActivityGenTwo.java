...
public class PokeListActivityGenTwo extends AppCompatActivity {


    ListView list;

    private String[] pokeName = new String[100];

    private String[] pokeID = new String[100];

    private String[] spriteUrls = new String[100];
    ...
    public void call() {
        ...
        executor.execute(new Runnable() {
            ...
            public void run() {
                ...
                String name_id = getDataFromHTTP("https://pokeapi.co/api/v2/pokemon?limit=100&offset=151");
...
//                                System.out.println("index + " + j);
                                ...
                                pokeID[j] = Integer.toString(j + 152);
                                int test = j+152;
                                System.out.println("numero : " + j+test);

                                String param = Integer.toString(j+152);
